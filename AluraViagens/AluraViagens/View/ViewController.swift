...
//  AluraViagens
//
//  Created by Igor fe Castro Figueiredo on 09/05/24.
//

import UIKit

class ViewController: UIViewController {
    @IBOutlet weak var viagemTableView: UITableView!
    ...
    func configuraTableView(){
        viagemTableView.register(UINib(nibName: "ViagemTableViewCell", bundle: nil), forCellReuseIdentifier: "ViagemTableViewCell");
        viagemTableView.dataSource = self
        viagemTableView.delegate = self
